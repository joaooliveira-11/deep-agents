...
from src.prompts import TASK_DELEGATION_DESCRIPTION_PREFIX
...
def _create_delegation_tool(tools, subagents: list[SubAgent], model, state_schema):
    ...
    @tool(description=TASK_DELEGATION_DESCRIPTION_PREFIX.format(other_agents=other_agents_string))
    def task(
            description: str,
            subagent_type: str,
